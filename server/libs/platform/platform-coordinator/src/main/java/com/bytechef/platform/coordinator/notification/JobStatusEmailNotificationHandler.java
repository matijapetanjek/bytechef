...
import com.bytechef.platform.configuration.notification.NotificationContext;
...
public class JobStatusEmailNotificationHandler implements EmailNotificationHandler {
    ...
    @Override
    public String getContent(NotificationContext notificationContext) {
        return messageSource.getMessage(
            "email." + notificationContext.getEventType() + ".content",
            new Object[] {
                notificationContext.getJobName(), notificationContext.getJobId()
            },
            Locale.getDefault());
    }

    @Override
    public String getSubject(NotificationContext notificationContext) {
        return messageSource.getMessage(
            "email." + notificationContext.getEventType() + ".subject",
            new Object[] {
                notificationContext.getJobName(), notificationContext.getJobId()
            },
            Locale.getDefault());
