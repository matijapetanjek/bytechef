    ...
    public void onApplicationEvent(ApplicationEvent applicationEvent) {
        if (applicationEvent instanceof JobStatusApplicationEvent jobStatusApplicationEvent) {
            ...
            for (Notification notification : notifications) {
                ...
                notificationSender.send(notification, notificationHandler, notificationContext);
            }
        }
    }

    private NotificationContext getNotificationContext(Event.Type eventType, Job job) {
        return new NotificationContext.Builder()
            .eventType(eventType)
            .jobId(job.getId())
