...
public class EmailNotificationSender implements NotificationSender<EmailNotificationHandler> {
    ...
    public void send(
        ...
        mailService.sendEmail(
            (String) settings.get("to"), emailNotificationHandler.getSubject(notificationContext),
            emailNotificationHandler.getContent(notificationContext), false, emailNotificationHandler.isHtml());
    }
}
